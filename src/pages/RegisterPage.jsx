    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-center -mt-16 min-h-screen">
        <div className="w-full max-w-sm px-6">
          <h2 className="text-2xl font-light tracking-wider text-ink text-center">Register</h2>
          <div className="w-8 h-px bg-ink-200 mx-auto mt-4 mb-10" />
          <form onSubmit={handleRegister} className="space-y-6">
            <div>
              <label className="block text-xs tracking-wider uppercase text-ink-300 mb-2" htmlFor="name">
                Name
              </label>
              <input
                type="text"
          ...
          <p className="text-xs text-ink-300 text-center mt-8">
            ...
            <Link to="/login" className="text-ink hover:text-ink-300 underline underline-offset-2">
              Login
            </Link>
          </p>
        </div>
